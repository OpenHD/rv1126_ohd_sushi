...
#ifndef EASYMEDIA_MP3_SERVER_MEDIA_SUBSESSION_HH_
#define EASYMEDIA_MP3_SERVER_MEDIA_SUBSESSION_HH_
...
namespace easymedia {
class MP3ServerMediaSubsession : public OnDemandServerMediaSubsession {
public:
  static MP3ServerMediaSubsession *createNew(UsageEnvironment &env,
...
protected: // we're a virtual base class
  MP3ServerMediaSubsession(UsageEnvironment &env, Live555MediaInput &mediaInput,
                           unsigned samplingFrequency, unsigned numChannels,
                           unsigned char profile);
  virtual ~MP3ServerMediaSubsession();
...
#endif // #ifndef EASYMEDIA_MP3_SERVER_MEDIA_SUBSESSION_HH_
